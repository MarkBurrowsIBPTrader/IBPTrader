...
CREATE TABLE `trades` (
  ...
  `mincommission` double(20,2) NOT NULL,
  `maxcommission` double(20,2) NOT NULL,
  ...
  `grossprofit` double(20,2) NOT NULL,
  `netprofit` double(20,2) NOT NULL,
  `sectype` text NOT NULL,
  `exchange` text NOT NULL,
  `primaryexchange` text NOT NULL,
  `currency` text NOT NULL,
  ...
  `createtimestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `batchsize` int(11) NOT NULL,
  `mintrend` double(20,2) NOT NULL,
  `maxtrend` double(20,2) NOT NULL,
  `actualtrend` double(20,2) NOT NULL,
...
-- Dump completed on 2014-04-26 11:25:30
